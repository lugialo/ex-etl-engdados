CREATE TABLE [fato_consulta_pagamento] (
  [id_fato] int PRIMARY KEY NOT NULL IDENTITY(1, 1),
...
CREATE TABLE [dim_odontologista] (
  [id_odontologista] int PRIMARY KEY NOT NULL,
...
CREATE TABLE [dim_procedimento] (
  [id_procedimento] int PRIMARY KEY NOT NULL,
...
CREATE TABLE [dim_tipo_pagamento] (
  [id_tipo_pagamento] int PRIMARY KEY NOT NULL,
